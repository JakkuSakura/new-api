...
export function getPaymentIcon(
  ...
  switch (paymentType) {
    ...
    case PAYMENT_TYPES.AIRWALLEX_WECHAT:
      return (
        <SiWechat
          className={className}
          style={{ color: PAYMENT_ICON_COLORS[PAYMENT_TYPES.AIRWALLEX_WECHAT] }}
        />
      )
    case PAYMENT_TYPES.AIRWALLEX_ALIPAY:
      return (
        <SiAlipay
          className={className}
          style={{ color: PAYMENT_ICON_COLORS[PAYMENT_TYPES.AIRWALLEX_ALIPAY] }}
        />
      )
    default:
      return <CreditCard className={className} />
