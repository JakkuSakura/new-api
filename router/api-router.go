...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.POST("/airwallex/webhook", anonymousRequestBodyLimit, controller.AirwallexWebhook)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/airwallex/status/:trade_no", controller.GetAirwallexPaymentStatus)
		...
		optionRoute.Use(middleware.RootAuth())
		{
			...
			optionRoute.GET("/fx/status", controller.GetFXStatus)
